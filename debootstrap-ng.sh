...
create_image()
{
	...
	local version="Armbian_${REVISION}_${BOARD_NAME}_${BUILD_DESKTOP_DE}_${DISTRIBUTION}_${RELEASE}_${VER/-$LINUXFAMILY/}"
	...
	mv $CACHEDIR/${SDCARD}.raw $DEST/images/${version}.img
