...
setenv load_dtb 'store dtb read $dtb_mem_addr; fdt addr $dtb_mem_addr'
if fatload usb 0:1 ${dtb_loadaddr} dtb.img; then setenv dtb_img "1"; else if load_dtb; then setenv dtb_img "1"; else setenv dtb_img "0";fi;fi;
...
if fatload mmc 0:1 ${dtb_loadaddr} dtb.img; then setenv dtb_img "1"; else if load_dtb; then setenv dtb_img "1"; else setenv dtb_img "0";fi;fi;
