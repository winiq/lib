...
setenv bootargs "root=LABEL=ROOTFS rootwait rootflags=data=writeback rw ${condev} no_console_suspend vout=hdmi,enable hdmimode=${m} m_bpp=${m_bpp} cvbsmode=${cvbsmode} cvbsdrv=${cvbs_drv} fsck.repair=yes net.ifnames=0 mac=00:15:18:01:81:31"
